...
- [Cross Site Request Forgery (CSRF)](https://github.com/alexbieber/Bug_Bounty_writeups#cross-site-request-forgery-csrf)
- [Clickjacking (UI Redressing Attack)](https://github.com/alexbieber/Bug_Bounty_writeups#clickjacking-ui-redressing-attack)
- [Local File Inclusion (LFI)](https://github.com/alexbieber/Bug_Bounty_writeups#local-file-inclusion-lfi)
- [Subdomain Takeover](https://github.com/alexbieber/Bug_Bounty_writeups#subdomain-takeover)
- [Denial of Service (DOS)](https://github.com/alexbieber/Bug_Bounty_writeups#denial-of-service-dos)
- [Authentication Bypass](https://github.com/alexbieber/Bug_Bounty_writeups#authentication-bypass)
- [SQL injection](https://github.com/alexbieber/Bug_Bounty_writeups#sql-injectionsqli)
- [Insecure Direct Object Reference (IDOR)](https://github.com/alexbieber/Bug_Bounty_writeups#insecure-direct-object-reference-idor)
- [2FA Related issues](https://github.com/alexbieber/Bug_Bounty_writeups#2fa-related-issues)
- [CORS Related issues](https://github.com/alexbieber/Bug_Bounty_writeups#cors-related-issues)
- [Server Side Request Forgery (SSRF)](https://github.com/alexbieber/Bug_Bounty_writeups/blob/master/README.md#server-side-request-forgery-ssrf)
- [Race Condition](https://github.com/alexbieber/Bug_Bounty_writeups/blob/master/README.md#race-condition)
- [Remote Code Execution (RCE)](https://github.com/alexbieber/Bug_Bounty_writeups#remote-code-execution-rce)
- [Android Pentesting](https://github.com/alexbieber/Bug_Bounty_writeups#android-pentesting)
- [Contributing](https://github.com/alexbieber/Bug_Bounty_writeups#contributing)
- [Maintainers](https://github.com/alexbieber/Bug_Bounty_writeups#maintainers)
...
- Open Pull Requests
- Send me links of writeups to My Twitter : [alexbieber12341](https://twitter.com/alexbieber12341)
